...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RSSReaderBundle:Tags')->findAll();
     ...
     * @Method("POST")
     * @Template("RSSReaderBundle:Tags:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RSSReaderBundle:Tags')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RSSReaderBundle:Tags:edit.html.twig")
     */
